...
def generate_launch_description():
    ...
    map_based_prediction_param_file = os.path.join(
        get_package_share_directory("autoware_map_based_prediction"), "config/map_based_prediction.param.yaml"
    )
    ...
    map_projection_loader_param_file = os.path.join(
        get_package_share_directory("map_projection_loader"), "config/map_projection_loader.param.yaml"
    )
